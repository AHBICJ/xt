<template>
  ...
  >
    <el-dialog  :visible.sync="dialogVisible" fullscreen="true">
      <span style="font-size: 200px;color: var(--main-color);position: absolute;top: 37%;left: 31%;">{{classinfo.classCode}}</span>
    ...
    <div>
      ...
      <el-dropdown style="float:right" v-if="user.role=='teacher'||user.role=='admin'">
